  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="bg-white w-full max-w-md p-6 rounded-lg shadow-lg dark:bg-gray-800">
        <h1 className="text-3xl font-bold text-black mb-4 text-center  dark:text-blue-300">Recuperar contraseña</h1>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="numeroIdentificacion" className="block text-sm font-medium mb-2 text-gray-700  dark:text-blue-300">
          ...
          <div>
            <label htmlFor="gmail" className="block text-sm font-medium mb-2 text-gray-700  dark:text-blue-300">
              Ingrese su Gmail:
            </label>
            <input
              id="gmail"
