  ...
  return (
    <div className="w-full h-screen bg-cover bg-center flex items-center justify-center  bg-gradient-to-r from-blue-400 to-purple-400 dark:bg-gradient-to-r dark:from-gray-900 dark:to-gray-700">
      <div className="bg-black bg-opacity-50 rounded-lg shadow-lg max-w-5xl w-full flex">
        <div className="relative w-1/2 p-10 dark:bg-gray-950 ">
              ...
              <form onSubmit={handleSubmit(onSubmit)} noValidate className="w-full ">
                <div className="">
                  ...
                  <input
                    ...
                    readOnly
                    className={`mt-2 p-3 w-full border rounded-full bg-gray-700 bg-opacity-50 text-white cursor-not-allowed ${
        ...
        <div className="w-1/2">
          <img src="../../../public/img/unl_2hd.jpeg" alt="Side Visual" className="w-full h-full object-cover rounded-r-lg" />
        </div>
      </div>
    </div>
  );
