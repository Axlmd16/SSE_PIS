    ...
    <nav className="flex items-center justify-between bg-gray-800 p-4">
      <div>
        <Link to="/" className="text-2xl font-bold tracking-wider ml-2">
          <span className="text-blue-400 hover:bg-gradient-to-r hover:from-blue-400 hover:via-purple-500 hover:to-purple-400 hover:text-transparent hover:bg-clip-text dark:text-green-600 dark:hover:bg-gradient-to-r dark:hover:from-green-600 dark:hover:via--600 dark:hover:to-purple-600 dark:hover:text-transparent ">
            UNL
          </span>
        </Link>
        <button
