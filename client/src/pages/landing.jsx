...
export const Landing = () => (
  <div className="bg-gray-100 dark:bg-gray-900 min-h-screen flex flex-col items-center justify-center py-12 sm:px-6 lg:px-8">
    <div className="max-w-4xl w-full text-center space-y-8">
      <h1 className="text-5xl font-bold text-gray-800 dark:text-gray-100">
        Bienvenido a <span className="text-blue-500 dark:text-blue-400">UNL</span>
      </h1>
      ...
      <div className="space-y-6">
        <Link
          to="/login"
          className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-500 hover:bg-blue-600 dark:bg-gray-700 dark:hover:bg-gray-300"
        >
          Iniciar Sesión
        </Link>
      </div>
    ...
    <footer className="bg-white dark:bg-gray-800 text-black dark:text-gray-100 py-6 w-full m-10 rounded-lg">
      <div className="max-w-4xl mx-auto text-center">
        <ul className="flex justify-center space-x-6">
          <li>
            <Link
              to="/autores"
              className="hover:text-purple-700 dark:hover:text-purple-400 font-bold transition-colors duration-300 dark:text-white"
            >
              Autores
            </Link>
          </li>
