...
export const Home_Principal = () => {
    return (
        <div className="bg-gradient-to-br from-gray-300 via-gray-400 to-gray-500 min-h-screen flex items-center justify-center">
            <div className="max-w-4xl px-8 py-12 bg-white bg-opacity-80 backdrop-filter backdrop-blur-lg shadow-lg rounded-lg">
